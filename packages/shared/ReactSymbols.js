...
export const REACT_FORAGMENT_TYPE:symbol=Symbol.for('react.fragment')
export const REACT_STARICT_MODE_TYPE:symbol=Symbol.for('react.strict_mode')
...
const MAYBE_ITERATOR_SYMBOL=Symbol.iterator // ? 迭代器,可以被循环使用？详细解析
const FAUX_ITERATOR_SYMBOL='@@iterator' // ?

export function getIteratorFn(maybeIterable:?any):?()=>?Iterator<any>{ //问号?表示参数可选
